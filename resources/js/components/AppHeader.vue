...
<template>
    <div>
        <div class="sticky top-0 z-50 border-b border-white/5 bg-black/80 shadow-sm backdrop-blur-xl">
            <div class="mx-auto flex h-16 items-center px-4 md:max-w-7xl">
                ...
                <div class="lg:hidden">
                    <Sheet>
                        ...
                        <SheetContent side="left" class="w-[300px] p-6 bg-black text-white border-r border-white/10">
