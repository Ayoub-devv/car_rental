...
const statusColors: Record<TicketStatusType, string> = {
    ...
    [TicketStatus.CLOSED]: 'bg-zinc-950 border border-white/10 text-zinc-200',
} as const;
            ...
            >
                ...
                <div class="space-y-4 min-h-[200px]">
                    <div
                        ...
                        class="rounded-md border border-dashed p-6 text-center text-sm text-zinc-200"
                    >
                    ...
                    >
                        <div
                            :class="[
                                ...
                                message.is_admin
                                    ? 'rounded-tl-none bg-zinc-950 border border-white/5 text-zinc-200'
