...
<template>
    ...
    <ClientLayout>
        <div class="p-4">
            <!-- Page Header -->
            <div class="mb-6 w-full rounded-lg bg-zinc-950 border border-white/10/60 backdrop-blur-xl p-6 shadow">
            ...
            <!-- Ticket Form -->
            <div class="w-full rounded-lg bg-zinc-950 border border-white/10/60 backdrop-blur-xl p-6 shadow">
                <form @submit.prevent="submitTicket" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            type="text"
                            class="mt-1 w-full rounded-lg border border-zinc-700 px-4 py-2 focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:outline-none"
