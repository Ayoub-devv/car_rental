            ...
            <div class="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:px-8">
                <div class="mb-20">
                    <div class="grid items-center gap-12 lg:grid-cols-2">
                        ...
                        <div class="rounded-lg bg-zinc-950 border border-white/10 p-8">
                            <div class="grid grid-cols-2 gap-6 text-center">
                                <div>
                                    <div
                                        class="mb-2 text-3xl font-bold text-red-500"
                                    >
                                        200+
                                    </div>
                ...
                <div class="mb-20">
                    ...
                    <div class="grid gap-8 md:grid-cols-3">
                        <div class="text-center">
                            <img
                                class="mx-auto mb-4 h-32 w-32 overflow-hidden rounded-full bg-zinc-950 border border-white/5 object-cover"
                ...
                <div
                    class="rounded-lg bg-black p-8 text-center text-white md:p-12"
                >
                    ...
                    <div class="flex flex-col justify-center gap-4 sm:flex-row">
                        <a
                            :href="fleet.url()"
                            class="rounded-lg bg-red-600 px-8 py-3 font-semibold text-white transition-colors duration-200 hover:bg-red-700"
                        >
                            Browse Our Fleet
                        </a>
                        <a
