...
import { AlertCircle, MoreVertical, Pencil, Trash2 } from 'lucide-vue-next';
                            ...
                            <td class="px-4 py-3 text-right">
                                <DropdownMenu>
                                    ...
                                    <DropdownMenuContent align="end" class="w-40 bg-background text-foreground border border-border">
                                        ...
                                        <DropdownMenuItem 
                                            class="flex items-center gap-2 text-red-600 cursor-pointer focus:text-red-600 focus:bg-red-50"
