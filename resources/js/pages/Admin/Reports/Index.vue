                            ...
                            <tbody class="divide-y divide-gray-200 bg-white text-black">
                                ...
                                >
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                        <span
                                            class="inline-flex rounded-full px-2 py-1 text-xs font-semibold  text-black"
                                            :style="{
                                                backgroundColor:
                                                    car.status_color,
                                            }"
                                    ...
                                    <td
                                        class="px-6 py-4 text-sm whitespace-nowrap text-center text-black"
                                    >
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <span
                                                class="min-w-0 text-sm text-black"
                                            >
                                    ...
                                    <td
                                        class="px-6 py-4 text-sm text-center whitespace-nowrap text-black"
                                    >
                                        {{
