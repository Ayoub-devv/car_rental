            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-8">
                    ...
                    >
                        <a
                            href="/fleet"
                            class="font-medium transition-colors duration-200 hover:text-red-500"
                            >{{ $t("nav.fleet") }}</a
                        >
                        <svg
                                ...
                                >
                                    <div>
                                        ...
                                        >
                                            ...
                                            <span
                                                class="flex items-center rounded-full bg-zinc-950 border border-white/10 px-3 py-1 capitalize"
                                            >
                                                <svg
                                                    class="mr-2 h-4 w-4"
                                                    fill="none"
